        ...
        <div className="border border-zinc-200 rounded-xl overflow-hidden">
            ...
            <div className="flex border-b border-zinc-200">
                <button
                    ...
                    className={`flex-1 px-4 py-2.5 text-sm text-center border-b-2 -mb-px transition-colors ${activeTab === "artwork"
                ...
                <button
                    ...
                    className={`flex-1 px-4 py-2.5 text-sm text-center border-b-2 -mb-px transition-colors ${activeTab === "proof"
                        ? "border-zinc-900 font-semibold text-zinc-900"
                        : "border-transparent text-zinc-500 hover:text-zinc-700"
                        }`}
                >
            ...
            <div className="grid grid-cols-2 gap-3 p-4">
                <button
                    type="button"
                    onClick={() => handleTabChange("artwork")}
                    className={`rounded-lg overflow-hidden border-2 ${activeTab === "artwork" ? "border-zinc-900" : "border-transparent"
                        }`}
                >
                    <img src={artworkImage} alt={`${title} artwork preview`} className="h-28 w-full object-cover bg-zinc-100" />
                </button>
                <button
                    type="button"
                    onClick={() => handleTabChange("proof")}
                    className={`rounded-lg overflow-hidden border-2 ${activeTab === "proof" ? "border-zinc-900" : "border-transparent"
                        }`}
                >
                    <img src={proveImage} alt={`${title} proof photo`} className="h-28 w-full object-cover bg-zinc-100" />
                </button>
            </div>
