...
const actions: {
    ...
    primary?: boolean;
        ...
        { status: "approved", label: "Approve & Publish", pendingLabel: "Approving...", icon: <Check />, primary: true },
        { status: "clarification", label: "Request Clarification", pendingLabel: "Requesting...", icon: <CircleQuestionMark /> },
