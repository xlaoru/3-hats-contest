            ...
            <div className="w-[50%] min-w-0">
                <div className="flex flex-col gap-4 pb-4 border-b border-zinc-300">
                    <div className="flex flex-col gap-1">
                        <Link href="/admin/submissions" className="text-sm text-gray-500 hover:text-gray-700 transition-colors inline-flex items-center gap-1 mb-6">← Back to submissions</Link>
