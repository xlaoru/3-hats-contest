        ...
        <div className="w-full rounded-xl border border-zinc-200 bg-white shadow-sm">
            <div className="flex items-center gap-6 overflow-x-auto border-b border-zinc-200 px-6 py-4">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <Button nativeButton={false} render={<Link href="/admin/submissions?status=pending" />}>
                        Review Pendings ({pendingCount})
                    </Button>
                    <Button nativeButton={false} variant="secondary" render={<Link href="/admin/submissions?status=clarification" />}>
                        View clarifications ({clarificationCount})
                    </Button>
                    <Button nativeButton={false} variant="secondary" render={<Link href="/admin/submissions" />}>
