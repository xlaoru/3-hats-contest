    ...
    return (
      <div className="bg-white rounded-2xl shadow-md p-8 text-center">
        ...
        <p className="text-sm text-gray-600">
          ...
          Click it to confirm your entry.
        </p>
        <p className="text-sm text-gray-600 mt-2">
          Reference number: <span className="font-mono">{referenceId}</span>
        </p>
        <p className="text-sm text-gray-600 mt-2">
          Once confirmed, your entry will wait for admin approval before appearing in the public
          gallery.
        </p>
      </div>
    )
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md p-8 space-y-4">
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-400 mt-1">Private — only visible to admins and judges.</p>
      ...
      <label className="flex items-start gap-2.5 text-sm text-gray-700">
        <input
          ...
          className="mt-0.5"
        />
        I agree to the competition rules — this artwork was created during a live life drawing
        session, with no studio reworking, AI, or photo copies.
      </label>
